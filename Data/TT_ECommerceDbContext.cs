...
namespace TT_ECommerce.Data
{
    public partial class TT_ECommerceDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-CLJC02\\TRUNGLE;Initial Catalog=TT_ECommerce;Integrated Security=True;Trust Server Certificate=True"); // Use your actual connection string here
            }
        }
